...
export function Top({ id, setID }) {
  ...
  async function LoadSongs() {
    let response = await fetch("https://localhost:44305/api/Songs", {
      method: "GET",
      headers: {
  ...
  async function DeleteSong(obj) {
    const response = await fetch(
      "https://localhost:44305/api/Songs/" + obj.id,
      {
        method: "DELETE",
        mode: "cors",
        cache: "no-cache",
...
export function AddMusic({ id, setID }) {
  ...
  async function GetGenres() {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    let response = await fetch("https://localhost:44305/api/Genres", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        //Authorization: bearer,
  ...
  async function addSong(song) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    const response = await fetch("https://localhost:44305/api/Songs", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "same-origin",
...
export function EditMusic({ id, setID }) {
  ...
  async function GetSongById() {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    let response = await fetch("https://localhost:44305/api/Songs/" + song_id, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        //Authorization: bearer,
  ...
  async function GetAuthorById(id) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    let response = await fetch("https://localhost:44305/api/Artists/" + id, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        //Authorization: bearer,
  ...
  async function GetGenreById(id) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    let response = await fetch("https://localhost:44305/api/Genres/" + id, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        //Authorization: bearer,
  ...
  async function EditSong(song) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    const response = await fetch(
      "https://localhost:44305/api/Songs/" + song_id,
      {
        method: "PUT",
        mode: "cors",
        cache: "no-cache",
