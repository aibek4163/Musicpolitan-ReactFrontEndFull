...
export function Releases({ id, setID }) {
  ...
  async function loadReleases() {
    let response = await fetch("https://localhost:44305/api/Releases", {
      method: "GET",
      headers: {
  ...
  async function DeleteRelease(obj) {
    const response = await fetch(
      "https://localhost:44305/api/Releases/" + obj.id,
      {
        method: "DELETE",
        mode: "cors",
        cache: "no-cache",
...
export function AddRelease({ id, setID }) {
  ...
  async function addRelease(artiles) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    const response = await fetch("https://localhost:44305/api/Releases", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "same-origin",
...
export function EditRelease() {
  ...
  async function GetReleaseById() {
    ...
    let response = await fetch(
      "https://localhost:44305/api/Releases/" + release_id,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
