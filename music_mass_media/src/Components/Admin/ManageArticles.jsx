...
export function Articles({ id, setID }) {
  ...
  async function LoadArticles() {
    let response = await fetch("https://localhost:44305/api/Articles", {
      method: "GET",
      headers: {
  ...
  async function DeleteArticle(obj) {
    ...
    const response = await fetch(
      "https://localhost:44305/api/Articles/" + article.id,
      {
        method: "DELETE",
        mode: "cors",
        cache: "no-cache",
...
export function AddArticle({ id, setID }) {
  ...
  async function addArticle(article) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    const response = await fetch("https://localhost:44305/api/Articles", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "same-origin",
...
export function EditArticle({ id, setID }) {
  ...
  async function GetArticleById() {
    ...
    let response = await fetch(
      "https://localhost:44305/api/Articles/" + article_id,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
