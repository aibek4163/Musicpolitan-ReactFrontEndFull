...
export function Review({ id, setID }) {
  ...
  async function LoadReview() {
    let response = await fetch("https://localhost:44305/api/Reviews", {
      method: "GET",
      headers: {
  ...
  async function DeleteReview(obj) {
    ...
    const response = await fetch(
      "https://localhost:44305/api/Reviews/" + obj.id,
      {
        method: "DELETE",
        mode: "cors",
        cache: "no-cache",
...
export function AddReviews({ id, setID }) {
  ...
  async function GetUsers() {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    let response = await fetch("https://localhost:44305/api/Users", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        //Authorization: bearer,
  ...
  async function AddReview(review) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    const response = await fetch("https://localhost:44305/api/Reviews", {
      method: "POST",
      mode: "cors",
      cache: "no-cache",
      credentials: "same-origin",
...
export function EditReview({ id, setID }) {
  ...
  async function GetReviewById() {
    ...
    let response = await fetch(
      "https://localhost:44305/api/Reviews/" + review_id,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  async function GetUserById(id) {
    //const bearer = "Bearer " + cookieJWT["jwt"].jwtToken;
    let response = await fetch("https://localhost:44305/api/Users/" + id, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        //Authorization: bearer,
